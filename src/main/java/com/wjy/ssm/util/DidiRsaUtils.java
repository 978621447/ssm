...
public class DidiRsaUtils {
       ...
       /* public static PrivateKey getPrivateKeyFromFile(String signType, String signFile)
        ...
        public static PrivateKey getPrivateKeyFromString(String signType, String keyStr) {
            ...
            try {
                ...
                return keyFactory.generatePrivate(keySpec); } catch (Exception e) {
            }
            return null;
        }
    ...
    private static String loadKeyFile(String fileName) throws FileNotFoundException {
       ...
       /* private static  final String topic
                = ReadProperties.readPropertiesFromfiles("/kafka/kafka_didi_producer.properties","topic","CONF_HOME");
*/


           /* String keyStr;
            InputStream inputStream = SignUtils.class.getClassLoader().getResourceAsStream(fileName);
            if (inputStream == null) {
                return null;
            }
